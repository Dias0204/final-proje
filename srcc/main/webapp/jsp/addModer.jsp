...
<form action="${pageContext.request.contextPath }/moderServlet" method="get" style="margin-bottom: 200px">
    <div class="login-box">
        ...
        <button class="btn" type="submit" name="action" value="clubModer">add to Club moders</button>
        <button class="btn" type="submit" name="action" value="eventModer">add to Event moders</button>
        <button class="btn" type="submit" name="action" value="newsModer">add to News moders</button>
    </div>
</form>
